          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3 sm:py-4">
            <div className="flex justify-between items-center">
              ...
              <div className="hidden md:flex gap-6 items-center">
                ...
                <div className="relative group">
                  <button className="text-foreground hover:text-primary transition text-sm">Startup Profiles</button>
                  <div className="absolute left-0 mt-2 w-48 bg-card/90 backdrop-blur border border-border/40 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
                    <button
                      onClick={() => router.push("/startupnest/mentor/add-profile")}
                      className="block w-full text-left px-4 py-2 text-foreground hover:text-primary transition text-sm"
                    >
                      Add Profile
                    </button>
                    <button
                      onClick={() => router.push("/startupnest/mentor/view-profiles")}
                      className="block w-full text-left px-4 py-2 text-foreground hover:text-primary transition border-t border-border/40 text-sm"
                    >
                      View Profiles
                    </button>
                  </div>
                ...
                <button
                  onClick={() => router.push("/startupnest/mentor/submissions")}
                  className="text-foreground hover:text-primary transition text-sm"
                >
                  Startup Submissions
                </button>
                <div className="text-xs sm:text-sm text-muted-foreground">Mentor: {userName}</div>
                <button
            ...
            {mobileMenuOpen && (
              <div className="md:hidden mt-4 space-y-2 pb-4 animate-in fade-in slide-in-from-top-2">
                ...
                <button
                  onClick={() => {
                    router.push("/startupnest/mentor/add-profile")
                    setMobileMenuOpen(false)
                  }}
                  className="block w-full text-left px-4 py-2 text-foreground hover:text-primary transition text-sm hover:bg-card/50 rounded"
                >
                ...
                <button
                  onClick={() => {
                    router.push("/startupnest/mentor/submissions")
                    setMobileMenuOpen(false)
                  }}
                  className="block w-full text-left px-4 py-2 text-foreground hover:text-primary transition text-sm hover:bg-card/50 rounded"
                >
                ...
                <div className="px-4 py-2 text-xs text-muted-foreground">Mentor: {userName}</div>
                <button
                  onClick={() => {
        ...
        <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-12 sm:py-20">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-12">
              Manage your startup funding opportunities and review submissions
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
              ...
              >
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">Create Profile</h3>
                <p className="text-sm sm:text-base text-muted-foreground">
                  Define your funding criteria and startup preferences
                </p>
              </div>
              ...
              <div
                ...
                className="p-6 sm:p-8 rounded-lg bg-card/50 backdrop-blur border border-border/40 hover:border-primary/50 transition cursor-pointer hover:scale-105 transform"
              >
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">My Profiles</h3>
                <p className="text-sm sm:text-base text-muted-foreground">View and manage your startup profiles</p>
              </div>
              ...
              <div
                ...
                className="p-6 sm:p-8 rounded-lg bg-card/50 backdrop-blur border border-border/40 hover:border-primary/50 transition cursor-pointer hover:scale-105 transform"
              >
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-3">Review Submissions</h3>
                <p className="text-sm sm:text-base text-muted-foreground">Evaluate and shortlist startup ideas</p>
              </div>
            </div>
          </div>
        </section>
